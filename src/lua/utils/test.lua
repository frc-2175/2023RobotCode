...
test("orientPath", function(t)
	...
	t:assertEqual(after.points[1], Vector:new(0, 0))
	t:assertEqual(after.points[2].x, 0)
	t:assertEqual(after.points[3].x, 0)

	t:assert(after.points[4].x > 0)
	t:assertEqual(after.points[4].y, after.points[3].y)
	t:assert(after.points[5].x > 0)
	t:assertEqual(after.points[5].y, after.points[3].y)
	t:assert(after.points[6].x > 0)
	t:assertEqual(after.points[6].y, after.points[3].y)

	-- extended points
	t:assertEqual(after.points[7].y, after.points[3].y)
	t:assertEqual(after.points[8].y, after.points[3].y)
	t:assertEqual(after.points[9].y, after.points[3].y)
	t:assertEqual(after.points[10].y, after.points[3].y)
end)
